...
@Mod(modid=PotionDescriptions.MODID, name=PotionDescriptions.NAME, version=PotionDescriptions.VERSION, dependencies=PotionDescriptions.DEPENDENCIES)
public class PotionDescriptions
{
    ...
    public static final String DEPENDENCIES = "after:rustic";
